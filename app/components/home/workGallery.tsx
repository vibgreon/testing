...
const works = [
  {
    num: "01",
    title: "Reduced onboarding drop-off by 20%",
    description:
      "Fixed activation leakage, re-architect unnecessary steps into soft opt-outs with re-engagement and recoverable blocks, with better context for different personas for recovery.",
  ...
  },
  {
    ...
    description:
      "Redesigned the options trading journey with P&L Protect for buyers and sellers, driving 49% growth in DTU/DAU and 2× seller retention over 6 months.",
  ...
  },
  {
    ...
    description:
      "Designed an experience to detect performance drops, trace root causes, and assign fix ownership across millions of BFSI calls.",
