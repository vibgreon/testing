      ...
      <div className="cont">
        ...
        <div className="detl_scroll">
          <div className="detl_list">
            <Context title={`Some Title`} desc={`Description about the title above`} details={`Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.`} cover={`/projects/example/untitled.png`} />
            <Context title={`Some Title`} desc={`Description about the title above`} details={`Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standexampled dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.`} cover={`/projects/example/untitled_2.png`} />
            <Context title={`Some Title`} desc={`Description about the title above`} details={`Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standexampled dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.`} cover={`/projects/example/untitled_3.png`} />
          </div>
        </div>
      </div>
    </>
